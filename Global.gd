...
const items = [
	...
	[ITEMTYPE.AURA, AURA.MORE_DAMAGE, "+25% Damage", "+25% weapon effectiveness but -25% hammer effectiveness"],
	[ITEMTYPE.AURA, AURA.MORE_HAMMER, "+25% Hammer", "+25% hammer effectiveness but -25% weapon effectiveness"],
